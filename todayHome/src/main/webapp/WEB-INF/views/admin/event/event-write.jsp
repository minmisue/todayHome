...
<script>
	...
	<div class="body-container">
		...
		<h2><i class="fa-brands fa-perbyte"></i> 이벤트 등록 </h2>
    	</div>
		<div class="content">
		    <div class="body-main">
					...
					<form name="eventForm" method="post" enctype="multipart/form-data">
						<table class="table table-border border-top2 table-form">
							<tr> 
								<td>제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
								<td> 
									<input type="text" name="title" maxlength="100" class="form-control" value="${dto.title}" style="width: 100%;">
								</td>
							</tr>
							...
							<tr>
								<td>시작일자</td>
								<td> 
									<input type="date" name="sday" class="form-control" value="${dto.sday}" style="width: 30%;">
									<input type="time" name="stime" class="form-control" value="${dto.stime}" style="width: 30%;">
								</td>
							</tr>
							...
							<tr>
								<td>종료일자</td>
								<td> 
									<input type="date" name="eday" class="form-control" value="${dto.eday}" style="width: 30%;">
									<input type="time" name="etime" class="form-control" value="${dto.etime}" style="width: 30%;">
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<p> 
										<input type="date" name="wday" class="form-control" value="${dto.wday}" style="width: 30%;">
										<input type="time" name="wtime" class="form-control" value="${dto.wtime}" style="width: 30%;">
									</p>

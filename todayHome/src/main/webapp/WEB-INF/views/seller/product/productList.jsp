...
<div class="body-container">
  ...
  <form id="searchForm" name="searchForm" action="${pageContext.request.contextPath}/seller/product/productList" method="post">
    <div class="filters">
    ...
    <table class="delivery-table" style="background: white; padding: 20px;">
      ...
      <c:forEach var="productForList" items="${searchProductBySellerId}" varStatus="status">
        <tr>
		  <td><a style=" text-decoration: none; color: black;" href="${pageContext.request.contextPath}/seller/product/product-list-detail/${productForList.productId}">${productForList.productId}</a></td>
          ...
          <td><a style=" text-decoration: none; color: black;" href="${pageContext.request.contextPath}/seller/product/${productForList.productId}">수정</a></td>
        </tr>
      </c:forEach>
    </table>
        <div class="button-container" style="display: flex; justify-content: center;">
          <button id="reset-button" class="styled-button" type="button" onclick="location.href='${pageContext.request.contextPath}/seller/product/productList';">초기화</button>

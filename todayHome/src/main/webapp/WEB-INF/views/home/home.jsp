		...
		<div class="content flex-row" style="height: 508px;">
			<div class="w-75" style="padding-right: 20px">
				<div class="w-100 h-100 img-container" style="overflow: hidden; position: relative">
					<img class="banner-card-img" onclick="location.href='${pageContext.request.contextPath}/community/picture/picture-article?userBoardId=463'" src="${pageContext.request.contextPath}/resources/picture/house-picture/2023071313230445459214120100.avif">
					<div class="flex-col main-banner-info">
						<div class="fw-bolder fs-2 main-banner-text" style="color:">우리들의 집들이</div>

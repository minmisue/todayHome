    ...
    <div class="body-main">
    	<div style="display: grid;grid-template-columns: repeat(2, 1fr);gap:10px; width:100%">
			<c:forEach var="eventlist" items="${eventlist}" varStatus="status">
				<div style="height: 230px;display: flex;flex-direction: column;" onclick="location.href='${pageContext.request.contextPath}/admin/event/detail?eventBoardId=${eventlist.eventBoardId }'">
					<div style="width: 100%;height: 160px;overflow: hidden;border-radius: 10px"><img style="width: 100%; height: 100%; border-radius: 10px" class="item-img" src="${pageContext.request.contextPath}/admin/uploads/event/${eventlist.eventImg}"> </div>

...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/mypage-menubar.css">
...
<header>
    <div class="menubar-container">
        ...
        <div class="menubar-item-bundle" style="gap: 18px">
            ...
            <%-- 로그인 --%>
            <img class="menubar-profile-img" src="${pageContext.request.contextPath}/resources/picture/default-profile.png" onclick="location.href='#'">
            <%----%>
...
<%--            --%>
    ...
    <div class="sub-menubar-container">
        <div class="sub-menubar">
            <div class="sub-item" onclick="location.href='${pageContext.request.contextPath}/'">리뷰쓰기</div>
            <div class="sub-item" onclick="location.href='${pageContext.request.contextPath}/'">내가작성한리뷰</div>
        </div>
    </div>
